...
## On-board LEDs
set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS33} [get_ports {io_out[0]}]
...
#set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS25} [get_ports o_Seven_Seg_P1_en_0_port_out_0]
...
#set_property -dict {PACKAGE_PIN E4 IOSTANDARD LVCMOS25} [get_ports o_Seven_Seg_P2_en_0_port_out_0]
...
#QSPI signals
#set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports {mosi}]
...
#set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports {ss[0]}]
#set_property -dict {PACKAGE_PIN N13 IOSTANDARD LVCMOS33} [get_ports {QSPI_RESET_B}]
#added qspi clk below
#this will not work, added tie back across to pmod for driving this clock
#tie back will not work based on schematic, qspi flash will not work for petalinux
#set_property -dict {PACKAGE_PIN C8 IOSTANDARD LVCMOS33} [get_ports {sck}]
