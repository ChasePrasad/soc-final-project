...
user.org:user:image_filter_ip:1.0\
...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S03_AXI_1 [get_bd_intf_pins S03_AXI] [get_bd_intf_pins smartconnect_0/S03_AXI]
...
proc create_hier_cell_axi_perifs { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 spi_sd
  ...
  create_bd_pin -dir I -from 0 -to 0 gpio_io_i_0
  create_bd_pin -dir O -from 0 -to 0 gpio_io_o_0
  create_bd_pin -dir I -type rst rst_0_0
  create_bd_pin -dir I -type rst locked
  ...
  create_bd_pin -dir I -type rst s_axi_aresetn2
  ...
  # Create instance: image_filter_ip_0, and set properties
  set image_filter_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:image_filter_ip:1.0 image_filter_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins image_filter_ip_0/PIXEL_IN]
  ...
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_pins axi_quad_spi_0/SPI_0] [get_bd_intf_pins spi_sd]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_pins UART_0] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net image_filter_ip_0_PIXEL_OUT [get_bd_intf_pins image_filter_ip_0/PIXEL_OUT] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M03_AXI [get_bd_intf_pins smartconnect_1/M03_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net smartconnect_1_M04_AXI [get_bd_intf_pins smartconnect_1/M04_AXI] [get_bd_intf_pins image_filter_ip_0/S_AXI_CTRL]
  connect_bd_intf_net -intf_net smartconnect_1_M05_AXI [get_bd_intf_pins smartconnect_1/M05_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]

  # Create port connections
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata  [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] \
  [get_bd_pins image_filter_ip_0/pixel_in_tdata]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tkeep  [get_bd_pins axi_dma_0/m_axis_mm2s_tkeep] \
  [get_bd_pins image_filter_ip_0/pixel_in_tstrb]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast  [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] \
  [get_bd_pins image_filter_ip_0/pixel_in_tlast]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid  [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] \
  [get_bd_pins image_filter_ip_0/pixel_in_tvalid]
  ...
  [get_bd_pins image_filter_ip_0/pixel_out_aresetn] \
  [get_bd_pins image_filter_ip_0/s_axi_ctrl_aresetn]
  ...
  [get_bd_pins image_filter_ip_0/pixel_in_aclk] \
  [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] \
  [get_bd_pins image_filter_ip_0/pixel_out_aclk] \
  [get_bd_pins axi_dma_0/s_axi_lite_aclk] \
  [get_bd_pins image_filter_ip_0/s_axi_ctrl_aclk] \
  [get_bd_pins axi_quad_spi_0/s_axi_aclk] \
  [get_bd_pins axi_quad_spi_0/ext_spi_clk]
  connect_bd_net -net s_axi_aresetn1_1 -boundary_type lower  [get_bd_pins s_axi_aresetn1]
  connect_bd_net -net s_axi_aresetn2_1  [get_bd_pins s_axi_aresetn2] \
...
proc create_hier_cell_perifs { parentCell nameHier } {
  ...
  # Create interface pins
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:lmb_rtl:1.0 SLMB
  ...
  create_bd_pin -dir O -from 0 -to 0 io_out
  create_bd_pin -dir I -type rst aresetn
  create_bd_pin -dir I -type rst processor_rst
  create_bd_pin -dir I -from 0 -to 0 gpio_io_i_0
  create_bd_pin -dir O -from 0 -to 0 gpio_io_o_0
  create_bd_pin -dir I -type rst hdmi_reset
  create_bd_pin -dir I -from 0 -to 0 Op1
  create_bd_pin -dir I -type clk clk_25MHz
  create_bd_pin -dir I -type clk clk_125MHz
  create_bd_pin -dir I -type clk clk_ref_i
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn [get_bd_intf_pins SLMB] [get_bd_intf_pins iomodule_0/SLMB]
  connect_bd_intf_net -intf_net axi_perifs_M_AXI_MM2S [get_bd_intf_pins axi_perifs/M_AXI_MM2S] [get_bd_intf_pins DDR/S02_AXI]
  connect_bd_intf_net -intf_net axi_perifs_M_AXI_S2MM [get_bd_intf_pins axi_perifs/M_AXI_S2MM] [get_bd_intf_pins DDR/S03_AXI]
  connect_bd_intf_net -intf_net axi_perifs_spi_sd [get_bd_intf_pins axi_perifs/spi_sd] [get_bd_intf_pins spi_sd]
  ...
  # Create port connections
  connect_bd_net -net axi_resetn_1  [get_bd_pins axi_resetn] \
  [get_bd_pins axi_perifs/axi_resetn]
  connect_bd_net -net clk_wiz_0_clk_25  [get_bd_pins clk_25MHz] \
  [get_bd_pins axi_perifs/clk_25MHz]
  connect_bd_net -net clk_wiz_0_clk_125  [get_bd_pins clk_125MHz] \
  [get_bd_pins axi_perifs/clk_125MHz]
  connect_bd_net -net clk_wiz_0_clk_200  [get_bd_pins clk_ref_i] \
  ...
  [get_bd_pins DDR/Op1] \
  [get_bd_pins axi_perifs/locked]
  connect_bd_net -net gpio_io_i_0_1  [get_bd_pins gpio_io_i_0] \
  [get_bd_pins axi_perifs/gpio_io_i_0]
  connect_bd_net -net iomodule_0_GPO1  [get_bd_pins iomodule_0/GPO1] \
  [get_bd_pins io_out]
  connect_bd_net -net mdm_1_debug_sys_rst  [get_bd_pins mb_debug_sys_rst] \
  ...
  [get_bd_pins iomodule_0/Clk]
  connect_bd_net -net mig_7series_0_init_calib_complete  [get_bd_pins DDR/init_calib_complete] \
  [get_bd_pins init_calib_complete]
  connect_bd_net -net perifs_gpio_io_o_0  [get_bd_pins axi_perifs/gpio_io_o_0] \
  [get_bd_pins gpio_io_o_0]
  connect_bd_net -net rst_0_0_1  [get_bd_pins hdmi_reset] \
  [get_bd_pins axi_perifs/rst_0_0]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_reset  [get_bd_pins Rst] \
  [get_bd_pins iomodule_0/Rst]
  connect_bd_net -net s_axi_aresetn1_1  [get_bd_pins s_axi_aresetn] \
  [get_bd_pins axi_perifs/s_axi_aresetn1]
  connect_bd_net -net s_axi_aresetn2_1  [get_bd_pins s_axi_aresetn1] \
  [get_bd_pins axi_perifs/s_axi_aresetn2]
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins dlmb_v10/LMB_Sl_1] [get_bd_intf_pins LMB_Sl_1]
...
proc create_root_design { parentCell } {
  ...
  set spi_sd_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 spi_sd_0 ]
  ...
  set hdmi_reset [ create_bd_port -dir I -type rst hdmi_reset ]
  set io_out [ create_bd_port -dir O -from 0 -to 0 io_out ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn [get_bd_intf_pins microblaze_0_local_memory/LMB_Sl_1] [get_bd_intf_pins perifs/SLMB]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports UART_0] [get_bd_intf_pins perifs/UART_0]
  ...
  connect_bd_intf_net -intf_net perifs_hdmi_tx_0_0 [get_bd_intf_ports hdmi_tx_0_0] [get_bd_intf_pins perifs/hdmi_tx_0_0]
  ...
  connect_bd_intf_net -intf_net perifs_spi_sd [get_bd_intf_pins perifs/spi_sd] [get_bd_intf_ports spi_sd_0]
  ...
  [get_bd_pins perifs/clk_25MHz] \
  [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_125  [get_bd_pins clk_wiz_0/clk_125] \
  [get_bd_pins perifs/clk_125MHz]
  ...
  connect_bd_net -net gpio_io_i_0_1  [get_bd_ports gpio_io_i_0] \
  [get_bd_pins perifs/gpio_io_i_0]
  connect_bd_net -net ilconstant_0_dout  [get_bd_pins ilconstant_0/dout] \
  [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  connect_bd_net -net iomodule_0_GPO1  [get_bd_pins perifs/io_out] \
  [get_bd_ports io_out]
  ...
  connect_bd_net -net mig_7series_0_init_calib_complete  [get_bd_pins perifs/init_calib_complete] \
  [get_bd_ports init_calib_complete]
  connect_bd_net -net perifs_gpio_io_o_0  [get_bd_pins perifs/gpio_io_o_0] \
  [get_bd_ports gpio_io_o_0]
  connect_bd_net -net rst_0_0_1  [get_bd_ports hdmi_reset] \
  [get_bd_pins perifs/hdmi_reset]
  ...
  [get_bd_pins perifs/s_axi_aresetn] \
  [get_bd_pins perifs/s_axi_aresetn1]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_reset  [get_bd_pins rst_clk_wiz_0_100M/peripheral_reset] \
  [get_bd_pins perifs/Rst]

  # Create address segments
  assign_bd_address -offset 0x41E00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/axi_quad_spi_0/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/image_filter_ip_0/S_AXI_CTRL/S_AXI_CTRL_reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/iomodule_0/SLMB/Reg] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/axi_dma_0/Data_MM2S] [get_bd_addr_segs perifs/DDR/mig_7series_0/memmap/memaddr] -force
  assign_bd_address -offset 0x80000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/axi_dma_0/Data_S2MM] [get_bd_addr_segs perifs/DDR/mig_7series_0/memmap/memaddr] -force
